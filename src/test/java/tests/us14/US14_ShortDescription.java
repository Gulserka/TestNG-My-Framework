...
public class US14_ShortDescription {
...
//Short Description alanina bilgi girilir         */
...
//
        ...
        assert us14_productTittlePage.shortDescription.isDisplayed();
        us14_productTittlePage.shortDescription.sendKeys("Laptop", Keys.ENTER);
        Assert.assertEquals(us14_productTittlePage.shortDescription.getText(), "Laptop");
